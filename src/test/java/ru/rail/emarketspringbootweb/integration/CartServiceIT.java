package ru.rail.emarketspringbootweb.integration;
...
import ru.rail.emarketspringbootweb.entity.*;
...
public class CartServiceIT {
    ...
    public void setUp() {
        //Set
        User user = new User();
        user.setUsername("ast111");
        user.setEmail("ast111");
        user.setPassword("ast111");
        ...
        product.setProductName("ast111");
        product.setDescription("ast111");
